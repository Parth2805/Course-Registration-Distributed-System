...
//    HashMap<String,HashMap<String,Integer>> co_cnt= new HashMap<>();
  ...
  //  HashMap<String,Integer> c_sencnt=new HashMap<>();
    ...
    String Students[]= {"COMPS6001","COMPS6002","COMPS6003"};
    ...
    public void intialize_main(){
        ...
        sem3.put("Winter",c2);
        sem3.put("Summer",c3); 
        st_en.put("COMPS6001",sem1);
        st_en.put("COMPS6002",sem2);
        st_en.put("COMPS6003",sem3);
        
        c_avf.put("COMP7001",3);
        c_avf.put("COMP7002",3);
        c_avf.put("COMP7003",3);
        c_av.put("Fall", c_avf);
        c_avw.put("COMP7004",3);
        c_avw.put("COMP7005",3);
        c_avw.put("COMP7001",3);
        c_av.put("Winter", c_avw);
        c_avs.put("COMP7006",3);
        c_avs.put("COMP7007",3);
        c_avs.put("COMP7002",3);
        c_av.put("Summer", c_avs);
        
       
        c_sencntf.put("COMP7001",0);
        c_sencntf.put("COMP7002",0);
        c_sencntf.put("COMP7003",0);
        c_sencnt.put("Fall", c_sencntf);
        c_sencntw.put("COMP7004",0);
        c_sencntw.put("COMP7005",0);
        c_sencntw.put("COMP7001",0);
        c_sencnt.put("Winter", c_sencntw);
        c_sencnts.put("COMP7006",0);
        c_sencnts.put("COMP7007",0);
        c_sencnts.put("COMP7002",0);
        c_sencnt.put("Summer", c_sencnts);
        
        ct1_cnt.put("Fall",0);
        ct1_cnt.put("Winter",0);
        ct1_cnt.put("Summer",0);
        cm_cnt.put("COMPS6001",ct1_cnt);
        ct2_cnt.put("Fall",0);
        ct2_cnt.put("Winter",0);
        ct2_cnt.put("Summer",0);
        cm_cnt.put("COMPS6002",ct2_cnt);
        ct3_cnt.put("Fall",0);
        ct3_cnt.put("Winter",0);
        ct3_cnt.put("Summer",0);
        cm_cnt.put("COMPS6003",ct3_cnt);
        
   /*     cot1_cnt.put("Fall",0);
        cot1_cnt.put("Winter",0);
        cot1_cnt.put("Summer",0);
        co_cnt.put("COMPS6001",cot1_cnt);
        cot2_cnt.put("Fall",0);
        cot2_cnt.put("Winter",0);
        cot2_cnt.put("Summer",0);
        co_cnt.put("COMPS6002",cot2_cnt);
        cot3_cnt.put("Fall",0);
        cot3_cnt.put("Winter",0);
        cot3_cnt.put("Summer",0);
        co_cnt.put("COMPS6003",cot3_cnt);*/
        
        count.put("COMPS6001", 0);
        count.put("COMPS6002",0);
        count.put("COMPS6003", 0);
   ...
   String call_other(String purpose,String courseid,String sem,int port){
		    ...
		    /*    for(Map.Entry<String,HashMap<String,Integer>> pair:cm_cnt.entrySet())
		      ...
		      System.out.println("Entered registration"+studentid+courseid+sem+" "+cm_cnt.get(studentid).get(sem));
		       ...
		       //     msg="Already Enrolled";
		        ...
		        {    
		            if(courseid.charAt(0)=='S'|| courseid.charAt(0)=='I'){
		                ...
		                if(count.get(studentid)==2){
		                   ...
		                   // msg = "Already enrolled in 2 elective subjects";
		                    ...
		                    if(courseid.charAt(0)=='S'){
		                        ...
		                        msg=call_other(purpose,courseid.trim(),sem.trim(),port);
	...
	public String removeCourseA(String courseid,String sem){
		...
		if(c_av.get(sem).containsKey(courseid)){
			...
			call_other("Notify",courseid,sem,9003);
	...
	synchronized public String listCourseAvailability (String sem){
		...
		String soencourses=call_other("Getcourses","null",sem,9002);        
		String insecourses=call_other("Getcourses","null",sem,9003);
