...
//    HashMap<String,HashMap<String,Integer>> co_cnt= new HashMap<>();
  ...
  //  HashMap<String,Integer> c_sencnt=new HashMap<>();
    ...
    String Students[]= {"SOENS6001","SOENS6002","SOENS6003"};
    ...
    public void intialize_main(){
        ...
        sem3.put("Winter",c2);
        sem3.put("Summer",c3); 
        st_en.put("SOENS6001",sem1);
        st_en.put("SOENS6002",sem2);
        st_en.put("SOENS6003",sem3);
        
        c_avf.put("SOEN6001", 3);
        c_avf.put("SOEN6002",3);
        c_avf.put("SOEN6003",3);
        c_av.put("Fall", c_avf);
        c_avw.put("SOEN6004",3);
        c_avw.put("SOEN6005",3);
        c_avw.put("SOEN6001",3);
        c_av.put("Winter", c_avw);
        c_avs.put("SOEN6006",3);
        c_avs.put("SOEN6007",3);
        c_avs.put("SOEN6002",3);
        c_av.put("Summer", c_avs);
        
       
        c_sencntf.put("SOEN6001",0);
        c_sencntf.put("SOEN6002",0);
        c_sencntf.put("SOEN6003",0);
        c_sencnt.put("Fall", c_sencntf);
        c_sencntw.put("SOEN6004",0);
        c_sencntw.put("SOEN6005",0);
        c_sencntw.put("SOEN6001",0);
        c_sencnt.put("Winter", c_sencntw);
        c_sencnts.put("SOEN6006",0);
        c_sencnts.put("SOEN6007",0);
        c_sencnts.put("SOEN6002",0);
        c_sencnt.put("Summer", c_sencnts);
        
        ct1_cnt.put("Fall",0);
        ct1_cnt.put("Winter",0);
        ct1_cnt.put("Summer",0);
        cm_cnt.put("SOENS6001",ct1_cnt);
        ct2_cnt.put("Fall",0);
        ct2_cnt.put("Winter",0);
        ct2_cnt.put("Summer",0);
        cm_cnt.put("SOENS6002",ct2_cnt);
        ct3_cnt.put("Fall",0);
        ct3_cnt.put("Winter",0);
        ct3_cnt.put("Summer",0);
        cm_cnt.put("SOENS6003",ct3_cnt);
        
   /*     cot1_cnt.put("Fall",0);
        cot1_cnt.put("Winter",0);
        cot1_cnt.put("Summer",0);
        co_cnt.put("SOENS6001",cot1_cnt);
        cot2_cnt.put("Fall",0);
        cot2_cnt.put("Winter",0);
        cot2_cnt.put("Summer",0);
        co_cnt.put("SOENS6002",cot2_cnt);
        cot3_cnt.put("Fall",0);
        cot3_cnt.put("Winter",0);
        cot3_cnt.put("Summer",0);
        co_cnt.put("SOENS6003",cot3_cnt);*/
        
        count.put("SOENS6001", 0);
        count.put("SOENS6002",0);
        count.put("SOENS6003", 0);
   ...
   String call_other(String purpose,String courseid,String sem,int port){
		    ...
		    /*    for(Map.Entry<String,HashMap<String,Integer>> pair:cm_cnt.entrySet())
		      ...
		      System.out.println("Entered registration"+studentid+courseid+sem+" "+cm_cnt.get(studentid).get(sem));
		       ...
		       //     msg="Already Enrolled";
		        ...
		        {    
		            if(courseid.charAt(0)=='C'|| courseid.charAt(0)=='I'){
	...
	synchronized public String listCourseAvailability (String sem){
		...
		String soencourses=call_other("Getcourses","null",sem,9001);        
